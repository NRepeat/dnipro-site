...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className="embla_v__button embla_v__button--prev verticalTopSliderButton"
      type="button"
      {...restProps}
    >
      <svg className="embla_v__button__svg" viewBox="0 0 532 532">
        <path
          fill="currentColor"
...
export const NextButton: React.FC<PropType> = (props) => {
  ...
  return (
    <button
      className="embla_v__button embla_v__button--next verticalBottomSliderButton"
      type="button"
      {...restProps}
    >
      <svg className="embla_v__button__svg" viewBox="0 0 532 532">
